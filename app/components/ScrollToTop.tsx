    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-40 p-3 bg-gradient-to-r from-accent-primary to-accent-secondary rounded-full shadow-lg hover:shadow-accent-primary/50 transition-shadow group"
