        ...
        >
          ...
          >
            ...
            <div className="relative aspect-video bg-black">
              <video autoPlay loop muted playsInline className="w-full h-full object-cover hero-video-background">
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-5xl md:text-6xl mb-4">🚀 Go Live & Unlock Premium</h2>
            <p className="text-xl md:text-2xl max-w-2xl mx-auto">
