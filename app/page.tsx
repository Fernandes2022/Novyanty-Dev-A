  ...
  return (
    <main className="min-h-screen bg-black text-white overflow-hidden">
          ...
          <div className="flex h-16 md:h-20 items-center justify-between">
            ...
            <div className="md:hidden flex items-center gap-3">
              ...
              <Link href="/workspace">
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-bold text-sm"
                >
                  Start
                </motion.button>
              </Link>
            ...
            {[
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${item.color.split(' ').join(' ')})`
                  }}
                />
                
                <div className="relative z-10">
                  <motion.div 
                    className={`w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-4 md:mb-6`}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <Tooltip key={i} content={feature.tooltip}>
                ...
                >
                  <motion.div
                    className="w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center mb-4 md:mb-6"
                    whileHover={{ rotate: 360, scale: 1.2 }}
                    transition={{ duration: 0.6 }}
                  >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              ...
              <Tooltip content="Generates absurd previews (Easter egg)">
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className={`px-4 md:px-6 py-3 rounded-xl font-bold transition-all ${
                    chaosMode 
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 px-4 py-2 glass rounded-lg border border-white/20 hover:border-purple-500/50 transition-colors text-sm"
                  >
      ...
      <section className="py-20 md:py-32 px-4 md:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <motion.div
              className="mt-8 md:mt-12 flex items-center justify-center gap-6 md:gap-8 flex-wrap"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false }}
              transition={{ duration: 0.8, delay: 0.3 }}
      ...
      <motion.footer 
        ...
        className="border-t border-white/10 py-8 md:py-12 px-4 md:px-6 lg:px-8 bg-black"
      >
        <div className="max-w-7xl mx-auto">
