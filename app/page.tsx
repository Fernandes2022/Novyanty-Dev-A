          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-8">
              <motion.button 
                ...
                whileHover={{ scale: 1.05, boxShadow: "0 20px 50px rgba(123, 92, 255, 0.6)" }} 
                whileTap={{ scale: 0.95 }} 
                animate={{
                  boxShadow: [
                    "0 10px 30px rgba(123, 92, 255, 0.3)",
                    "0 15px 45px rgba(123, 92, 255, 0.5)",
                    "0 10px 30px rgba(123, 92, 255, 0.3)"
                  ]
                }}
                transition={{
                ...
                className="relative flex-1 px-8 py-4 bg-gradient-to-r from-accent-primary to-accent-secondary text-white rounded-xl font-bold text-lg shadow-lg shadow-accent-primary/30 hover:shadow-xl hover:shadow-accent-primary/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden group"
              >
...
<GradientDivider />
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-16 md:py-24 px-4 md:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
